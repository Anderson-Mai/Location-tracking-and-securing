...
public final class Constants {
    ...
    public static final String PASSING_VALUE = "PASSING_VALUE";
    public static final int PASSING_RESTART = 111;
    public static final int  PASSING_NEWSTART = 112;
    public static final String STOP_LOCATION_UPDATE_ACTION = "STOP_LOCATION_UPDATE_ACTION_081";
    public static final String CLOSE_APP_ACTION = "CLOSE_APP_ACTION_081";
    public static final String REQUEST_CONNECT_FROM_BASE = "REQUEST_CONNECT_FROM_BASE_081";
    public static final String START_GEOFENCE_ACTION = "START_GEOFENCE_ACTION_081";
}
